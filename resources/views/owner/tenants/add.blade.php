                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="tenants-inner-box-block">
                                                            <div class="add-property-title border-bottom pb-25 mb-25">
                                                                <h4>{{ __('Personal Information (KYC)') }}</h4>
                                                            </div>
                                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-25">
                                                                    <label
                                                                        class="label-text-title color-heading font-medium mb-2">Date of Birth
                                                                        <span class="text-danger">*</span></label>
                                                                ...
                                                                <div class="col-md-6 mb-25">
                                                                    <label
                                                                        class="label-text-title color-heading font-medium mb-2">Next of Kin
                                                                        <span class="text-danger">*</span></label>
                                                                ...
                                                                <div class="col-md-6 mb-25">
                                                                    <label
                                                                        class="label-text-title color-heading font-medium mb-2">Relationship with Next of Kin
                                                                        <span class="text-danger">*</span></label>
                                                                    <input type="text" name="family_member"
                                                                        class="form-control"
